...
var CACHE_VERSION = "v1.0.0-public-release-final-2026-08-12";
...
var SHELL_PRECACHE = [
  ...
  "./assets/adv/hub.js",
  "./assets/adv/hub.css",
  "./assets/adv/home-extra.js",
  "./assets/adv/home-extra.css",
  "./assets/adv/entry.js",
  ...
  "./assets/img/hero-1280.jpg",
  "./assets/img/apple-touch-icon.png",
  "./assets/img/signature-white.png",
  "./assets/img/favicon-64.png",
  "./assets/img/icon-192.png",
  "./assets/adv/three.min.js",
  "./assets/adv/waha-adventure.js",
  "./assets/adv/waha-adventure.css",
  "./grade1/index.html",
  "./grade2/index.html",
  "./grade3/index.html",
  "./grade4/index.html"
...
self.addEventListener("fetch", function (event) {
  ...
  /* Navigations are network-first and fall back to the cached DOCUMENT.
     The entry gate routes with query strings (?adv=1&role=student); those
     parameters change behaviour inside the page, not which file is served,
     so offline lookup deliberately ignores the query. A response carrying a
     query string is still never written to the cache. */
  if (request.mode === "navigate") {
    event.respondWith(
      fetch(request)
        .then(function (response) {
          return url.search ? response : putRuntime(request, response);
        })
        .catch(function () {
          var path = url.pathname;
          return fromCache(path).then(function (hit) {
            if (hit) { return hit; }
            var alt = path.slice(-1) === "/" ? path + "index.html" : null;
  ...
  /* Non-navigation requests with a query string stay live: they are data,
     and a stale cached copy could show outdated progress. */
